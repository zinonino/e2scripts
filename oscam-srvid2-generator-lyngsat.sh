...
create_srvid_file()
{
    ...
    SID_MATCH='<td align="center"><font face="Verdana" size=[0-9]+>[0-9 ]+</td>'
    ...
    echo -e "$RESULT" > "/tmp/oscam__${1}.srvid2"
}
...
create_srvid_file "Sky-Deutschland" "09C4,098C,098D" "SKY DE"
